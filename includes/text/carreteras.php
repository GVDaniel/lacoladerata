...
<div class="pd-container">
    ...
    <div class="col-md-6">
        <p class="long-text">
            ...
            <h6 style="font-style: italic;">De 30 municipios que tiene el departamento de Chocó, 13 no tienen conexión por carretera y sólo se puede llegar a ellos en bote por los ríos, en barco o en avioneta.</h6>
        </p>
    ...
    <div class="col-md-6">
        ...
        <h1 class="underline">CHARAMBIRÁ: OTRA COMUNIDAD EN RIESGO</h1>
            ...
            <br><br>
            Descubra en la <b>línea</b> de tiempo a continuación, cómo, a pesar de las enormes sumas invertidas por el gobierno, <b>viajar por las rutas interdepartamentales de Chocó sigue siendo una travesía peligrosa que ya se ha cobrado muchas vidas.</b>
            <br><br>
            <b>Para visualizar mejor el contenido, se recomienda oprimir el botón “present” o el símbolo ( <i class="fa fa-play"></i> ), y navegar con la tecla enter o con las flechas azules de la parte inferior derecha. Desde el móvil se sugiere la orientación horizontal. Si desea ampliar las fotografías puede darles click.</b>
        </p>
    </div>
    <div class="col-md-12">
        <script src="https://assets.sutori.com/frontend-assets/assets/iframeResizer.js"></script>
        <iframe src="https://www.sutori.com/story/linea-de-tiempo-vias-del-choco-promesas-y-derrumbes--3h2UHS7gAEJE4Sgrk8FqrYeL/embed" width="100%" frameborder="0" allowfullscreen="allowfullscreen" scrolling="no" id="iFrameResizer0" style="overflow: hidden; height: 9871px;"></iframe>
