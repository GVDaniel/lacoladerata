...
<div class="pd-container">
    <div class="col-md-12 text-center" id="TEXT">
        ...
        <h1 class="title_post">Chocó sigue sin unirse a Colombia</h1>
    </div>
    <div class="col-md-6">
        <p class="long-text">
...
<script src="https://assets.sutori.com/frontend-assets/assets/iframeResizer.executer.js"></script>
    <script src="https://assets.sutori.com/frontend-assets/assets/iframeResizer.js"></script>
        <iframe src="https://www.sutori.com/story/linea-de-tiempo-vias-del-choco-promesas-y-derrumbes--3h2UHS7gAEJE4Sgrk8FqrYeL/embed" width="100%" frameborder="0" allowfullscreen="allowfullscreen" scrolling="yes" id="iFrameResizer0" style="overflow: hidden; height: 9000px;"></iframe>
    </div>
