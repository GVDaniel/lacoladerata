...
<div class="pd-container">
    ...
    <div class="col-md-6">
        ...
        <h1 class="questions">¿Entonces es una victoria de los paros cívicos?</h1>
        <p class="long-text">
        ...
        <h1 class="questions">¿Eso de que la vía aparece como pavimentada en mapas del entonces Ministerio de Obras Públicas desde los años noventa es cierto?</h1>
        <p class="long-text">
        No, eso es un mito. La pavimentación arrancó en el 2009.<br><br>
        </p>
        <h1 class="questions"> Hay testimonios que aún en los ochenta la gente hacía la ruta a pie con trasbordos porque sólo había tramos de la carretera.</h1>
        <p class="long-text">
        ...
        <h1 class="questions">¿Qué representa para este departamento con medio millón de habitantes no contar en pleno siglo XXI con una carretera en buenas condiciones para conectarse al resto del país?</h1>
        <p class="long-text">
        ...
        <h1 class="questions"> ¿Qué balance hay de las exigencias que hizo el paro cívico en educación y salud?</h1>
        <p class="long-text">
    ...
    <div class="col-md-6">
        ...
        <h1 class="questions">¿Y qué pasa con el Hospital San Francisco de Asís que cada día está más quebrado?</h1>
        <p class="long-text">
        ...
        <h1 class="questions">¿Los gobernadores qué tienen que ver ahí?</h1>
        <p class="long-text">
        ...
        <h1 class="questions">Hábleme de las exigencias del paro cívico frente a la educación</h1>
        <p class="long-text">
        ...
        <h1 class="questions">Tengo la idea que desde los años cincuenta bajo el liderazgo de Diego Luis Córdoba había un espíritu del pueblo chocoano por educarse, conozco gente en los ríos que empeña lo que sea para mandar sus hijos a estudiar afuera…</h1>
        <p class="long-text">
        ...
        <h1 class="questions">En el interior del país, que es modernizado, que tiene vías e infraestructura mejores, hay un imaginario de que el Chocó es corrupto. Pienso que eso se mezcla con cierto prejuicio racista de que los negros son malos administradores. ¿Usted cree que el Chocó es corrupto?</h1>
        <p class="long-text">
