<div class="col-md-12">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item active">
            <img src="./images/corrupcion/fotos/1.jpg" alt="Rio Ingará, San José del Palmar">
        ...
        <div class="item">
            <img src="./images/corrupcion/fotos/2.jpg" alt="Casa chocoana">
            <div class="carousel-caption">
        ...
        <div class="item">
            <img src="./images/corrupcion/fotos/3.jpg" alt="Santa María de Urábara">
            <div class="carousel-caption">
        ...
        <div class="item">
            <img src="./images/corrupcion/fotos/4.jpg" alt="Máquina de Enerpacific SAS">
            <div class="carousel-caption">
...
<div class="pd-container">
    ...
    <div class="col-md-6">
        <p class="long-text">
            <h1 class="underline">Por fin van a terminar las carreteras al Chocó…</h1>
            ...
            <br><br>
            <img src="./images/corrupcion/fotos/5.jpg" width="100%">
            <div class="help-text">Jorge Salgado ha sido corresponsal de El Tiempo y director del semanario Chocó 7 Días. Hace cuatro décadas que vive en el departamento. Como veedor ciudadano ha impulsado activamente el comité que lideró los últimos paros cívicos del Chocó.</div>
            <h1 class="underline">¿Entonces es una victoria de los paros cívicos?</h1>
            ...
            <h1 class="underline">¿Eso de que la vía aparece como pavimentada en mapas del entonces Ministerio de Obras Públicas desde los años noventa es cierto?</h1>
            No, eso es un mito. La pavimentación arrancó en el 2009.<br><br>
            <h1 class="underline"> Hay testimonios que aún en los ochenta la gente hacía la ruta a pie con trasbordos porque sólo había tramos de la carretera.</h1>
            <br><br> Sí, en la vía a Risaralda, que también tiene su historia y se habla de ella desde fines del siglo XIX; pero la verdad es que se abrió durante el gobierno de Belisario Betancur. Para hablarlo de manera franca, ahí no tuvo que ver ningún paro. Es la vía al mar de Risaralda y Caldas.
            <h1 class="underline">¿Qué representa para este departamento con medio millón de habitantes no contar en pleno siglo XXI con una carretera en buenas condiciones para conectarse al resto del país?</h1>
            ...
            <br><br>
            <h1 class="underline"> ¿Qué balance hay de las exigencias que hizo el paro cívico en educación y salud?</h1>
    ...
    <div class="col-md-6">
        <p class="long-text">
            <h1 class="underline"> ¿Cuando alguien tiene una complicación medianamente grave corre riesgo de morir?</h1>
            ...
            <h1 class="underline">Es culpa también del modelo…</h1>
            Claro, la principal culpa es del modelo de salud, de la ley 100, que hace que aumente la desigualdad a nivel nacional.
            <h1 class="underline">¿Y qué pasa con el Hospital San Francisco de Asís que cada día está más quebrado?</h1>
            ...
            <h1 class="underline">¿Los gobernadores qué tienen que ver ahí?</h1>
            ...
            <h1 class="underline">Hábleme de las exigencias del paro cívico frente a la educación</h1>
            ...
            <h6 style="font-style: italic;">"Cuatro movimientos similares en el siglo XX y cinco más en lo que va corrido del XXI configuran una larga tradición de protestas ciudadanas que comienzan en 1914; es la manera como el departamento más abandonado por el país consigue que Colombia mire a sus territorios."</h6>
            <h1 class="underline">Tengo la idea que desde los años cincuenta bajo el liderazgo de Diego Luis Córdoba había un espíritu del pueblo chocoano por educarse, conozco gente en los ríos que empeña lo que sea para mandar sus hijos a estudiar afuera…</h1>
            ...
            <h1 class="underline">En el interior del país, que es modernizado, que tiene vías e infraestructura mejores, hay un imaginario de que el Chocó es corrupto. Pienso que eso se mezcla con cierto prejuicio racista de que los negros son malos administradores. ¿Usted cree que el Chocó es corrupto?</h1>
            ...
            <h1 class="underline">¿Es una narrativa para culpar a los chocoanos del atraso en su departamento?</h1>
